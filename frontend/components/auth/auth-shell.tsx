...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-4 py-4 sm:px-6 sm:py-6 lg:px-0 lg:py-0">
        <div className="grid flex-1 gap-8 lg:min-h-screen lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-0 xl:grid-cols-[1.22fr_0.98fr]">
          <section className="flex items-start justify-center overflow-hidden pt-2 lg:h-full lg:px-10 lg:pt-4 xl:px-16 xl:pt-6">
            <div className="w-full max-w-[690px]">
              ...
              <div className="-mt-2 xl:mt-0">
                ...
                <motion.h1
                  ...
                  className="mt-5 max-w-[560px] text-[34px] font-bold leading-[1.04] tracking-[-0.055em] text-[#0F172A] sm:text-[42px] lg:text-[54px] xl:text-[60px]"
                >
          ...
          <section className="flex min-h-0 flex-col justify-center pb-2 lg:h-full lg:px-10 xl:px-16">
